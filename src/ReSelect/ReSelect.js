            ...
            <div className="container">
              <div className='select-multiple'>
                ...
                {(this.state.selectValue === '') ?
                 ...
                 onInput={ this.onTextChange } onFocus={this.showOptions} onClick={this.clear} 
                 className="message">{(this.state.clear) ? '' : this.props.message}
                 </div> : 
              ...
              <ul className='options'>                
                ...
                {(this.state.filteredOptionsList.length === 0 && this.state.searching) ?

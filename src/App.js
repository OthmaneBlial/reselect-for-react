        ...
        <section className="hero is-info is-large">
          <div className="hero-body">
            <div className="container has-text-centered">
              ...
              <a
                href="https://github.com/OthmaneBlial/reselect-for-react/"
            ...
            <div className="container">
              <div className="columns">
                <div className="column is-6">
                  <h1 className="title">ReSelect with one option</h1>
                ...
                <div className="column is-6">
                  <h1 className="title">ReSelect with multiple options</h1>
                  <div className="reselect">
                    <ReSelectMultiple
                      options={[
                        "Argentina",
        ...
        <footer class="footer">
          <div class="container">
            <div class="content has-text-centered">
              <p>
                <strong>ReSelect</strong> by{" "}
                <a href="https://github.com/OthmaneBlial">Othmane Blial</a>. The
